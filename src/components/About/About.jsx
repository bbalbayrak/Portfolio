...
const About = () => {
  ...
  return (
    <Fragment>
      <div className="container max-sm:overflow-auto mx-auto flex-wrap flex justify-around max-sm:grid p-7 pt-48 h-screen min-h-screen bg-gradient-to-bl from-red-500 via-amber-400 to-amber-100">
